...
import tipo1 from '../../../assets/brochure/tipo1.png'
import tipo2 from '../../../assets/brochure/tipo2.png'
import tipo3 from '../../../assets/brochure/tipo3.png'
import tipo4 from '../../../assets/brochure/tipo4.png'
...
import estilo1 from '../../../assets/flyer/estilo1.jpg'
import estilo2 from '../../../assets/flyer/estilo2.jpg'
...
const Flyerprueba = () => {
  ...
  const longText2 = `Suele ver más elementos y figuras, además los colores suelen resaltar sobre todo, y las imágenes suelen tener una forma que no sea solo rectangular.`;
            ...
            <form action="" className="">
              <div>
                <ol>
                  ...
                  <li>
                    <h5>
                      ¿Cuál es el nombre comercial de la empresa?
                      {/* <Popover>
                        <PopoverHandler>
                  ...
                  <div className="mb-10">
                    <li>
                      <h5>
                        Medidas que desea para su Flyer (*){" "}                       
                      </h5>
                    ...
                    >
                      <div className="w-full">
                        ...
                        <div className="w-full border p-4 flex flex-col gap-1 ">
                          ...
                          >
                            Ancho <input type="text" className="input" placeholder="Medidas en píxeles"/>
                          </label>
                          ...
                          <label
                            ...
                            className="btn btn-primary col-md-12 text-black mb-2 flex items-center gap-1"
                          >
                            Alto <input type="text" className="input" placeholder="Medidas en píxeles"/>
                          </label>
                  ...
                  <li>
                    ...
                    <Errors error={errors.categoria} />
                  </li>

                  <li>
                    <h5>
                        Adjunta tu logotipo (Adjunta solo la imagen, si tienes tu logo en formato por favor enviarlo por Whatsapp)
                    </h5>
                  ...
                  <li>
                    ...
                    <Errors error={errors.descripcion} />
                  </li>
           
                  <li>
                    <h5>
                     Adjunta un enlace de Google Drive que contenga las imágenes que desear agregar en tu Flyer
                    </h5>
                    <div className="input">
                      <input
                        type="text"
                    ...
                    <Errors error={errors.imagenes} />
                  </li>

                  <li>
                    <h5>
                      Colores que deseas para tu flyer
                      {/* <Popover>
                        <PopoverHandler>
                          <Button>Show Popover</Button>
                        </PopoverHandler>
                    ...
                    <div className="input">
                      <input
                        type="text"
                        placeholder="Colores que deseas incluir en tu flyer para llamar la atención"
                        name="colores"
                        {...register("colores", {
                          required: {
                            value: true,
