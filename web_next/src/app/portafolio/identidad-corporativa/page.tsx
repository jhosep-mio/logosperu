...
export const metadata = {
  title: 'Portafolio de Identidad coporativa - Logos Perú',
  description:
    'Diseño estratégico y cuidadosamente curado, fortalecemos y elevamos la presencia de marcas, asegurando que cada una se destaque con una imagen coherente y poderosa que genere impacto y reconocimiento.',
  msvalidate: 'A01D8EBEAA551809606CCFFE234E6DF5',
  alternate: {
    canonical: 'https://logosperu.com.pe/portafolio/identidad-corporativa'
  },
  themeColor: '#4e54c8',
  ...
  openGraph: {
    ...
    description:
      'Diseño estratégico y cuidadosamente curado, fortalecemos y elevamos la presencia de marcas, asegurando que cada una se destaque con una imagen coherente y poderosa que genere impacto y reconocimiento.',
    url: 'https://logosperu.com.pe/portafolio/identidad-corporativa',
...
export default async function Portafolio () {
  const texto = 'identidad-corporativa'
