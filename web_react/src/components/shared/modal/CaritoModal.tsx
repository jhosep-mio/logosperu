...
import { RemoveItem } from '../carrito/RemoveItem'
        ...
        <section className="w-full h-screen relative">
          ...
          >
            ...
            <div className="relative pt-16 lg:pt-8 text-gray-300 p-8 h-full">
              <IoCloseCircle className="absolute right-4 top-4 p-3 box-content text-gray-300 bg-[#262837] rounded-full text-xl md:text-3xl cursor-pointer" onClick={() => { setOpen(false) }}/>
              ...
              <div className="bg-[#262837] absolute w-full bottom-0 left-0 p-4">
                <div>
                  <button className="bg-primary w-full py-2 px-4 rounded-lg text-3xl">
