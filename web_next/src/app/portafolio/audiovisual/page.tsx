...
export const metadata = {
  title: 'Portafolio Audiovisual - Logos Perú',
  description:
    'En nuestro amplio cátalogo de servicios audiovisuales, destacamos la creación de videos corporativos, animaciones promocionales y la animación de logotipos. Estamos comprometidos en brindar soluciones visuales efectivas para diversos entornos digitales, permitiendo la transmisión dinámica e interactiva de ideas y mensajes.',
  msvalidate: 'A01D8EBEAA551809606CCFFE234E6DF5',
  alternate: {
    canonical: 'https://www.logosperu.com.pe/portafolio/audiovisual'
  },
  themeColor: '#4e54c8',
  ...
  openGraph: {
    ...
    description:
      'En nuestro amplio cátalogo de servicios audiovisuales, destacamos la creación de videos corporativos, animaciones promocionales y la animación de logotipos. Estamos comprometidos en brindar soluciones visuales efectivas para diversos entornos digitales, permitiendo la transmisión dinámica e interactiva de ideas y mensajes.',
    url: 'https://www.logosperu.com.pe/portafolio/audiovisual',
