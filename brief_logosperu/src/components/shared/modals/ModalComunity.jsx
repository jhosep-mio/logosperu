...
export const ModalComunity = ({
  ...
  const registrarBrief = async () => {
    if (longitud && latitud) {
      ...
      data.append("propuesta_valor", formulario.propuesta_valor);
      data.append("objetivos_especificos", formulario.objetivos_especificos);
      data.append("clientes_ideales", formulario.clientes_ideales);
      data.append("propuesta_producto", formulario.propuesta_producto);
      data.append("preferencia_canal", formulario.preferencia_canal);
      data.append("presupuesto", formulario.presupuesto);
      data.append("link_recursos", formulario.link_recursos);
      data.append("fechas_importantes", formulario.fechas_importantes);
      data.append("directrises_marca", formulario.directrises_marca);
      data.append("elementos_visuales", formulario.elementos_visuales);
      data.append("restricciones_legales", formulario.restricciones_legales);
      data.append("factores_consideracion", formulario.factores_consideracion);
      try {
        let respuesta = await axios.post(
          `${Global.url}/saveBriefComunity`,
          data
        );
