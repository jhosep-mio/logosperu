...
import { type ImagePreviewProps } from './../schemas/Interfaces'

export const ImageVideoUploader = ({ url, setUrl, boton, setBoton, setImagen, clase }: ImagePreviewProps): JSX.Element => {
