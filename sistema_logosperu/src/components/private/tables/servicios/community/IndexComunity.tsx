...
export const IndexComunity = ({ cards, datos, getOneBrief }: { cards: Card[], datos: values, getOneBrief: () => Promise<void> }): JSX.Element => {
...
const SelectedCard = ({ selected, datos, getOneBrief }: { selected: Card | null, datos: values, getOneBrief: () => Promise<void> }): JSX.Element => {
  return (
