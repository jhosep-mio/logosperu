...
export const metadata = {
  title: 'Portafolio de Animación de Logotipo - Logos Perú',
  description:
    'Da vida a tu marca con nuestro servicio de animación de logotipo: transformaciones dinámicas, efectos visuales cautivadores y personalización creativa. ¡Destaca en el mercado digital y cautiva a tu audiencia desde el primer clic',
  msvalidate: 'A01D8EBEAA551809606CCFFE234E6DF5',
  alternate: {
    canonical: 'https://www.logosperu.com.pe/portafolio/audiovisual/animacion_logotipo'
  },
  themeColor: '#4e54c8',
  ...
  openGraph: {
    ...
    description:
      'Da vida a tu marca con nuestro servicio de animación de logotipo: transformaciones dinámicas, efectos visuales cautivadores y personalización creativa. ¡Destaca en el mercado digital y cautiva a tu audiencia desde el primer clic',
    url: 'https://www.logosperu.com.pe/portafolio/audiovisual/animacion_logotipo',
...
export default async function Portafolio () {
  const texto = 'animacion_logotipo'
  ...
  return (
    <>
      ...
      <section className='max-w-[1200px] mx-auto mb-24'>
        <div className='mb-16' id='userefprimercontenido'>
          <ul className='w-full flex flex-wrap items-center justify-center text-3xl py-5'>
            {subcategorias.map((sub) => (
              <Link
                href={`/portafolio/audiovisual/${sub.url}`}
        ...
        <Contenido items={items} titulo={productos.titulo} ruta='audiovisual' />
      </section>
    </>
  )
}
