...
export const metadata = {
  title: 'Portafolio de Paginas web - Logos Perú',
  description:
  ...
  alternate: {
    canonical: 'https://logosperu.com.pe/portafolio/diseno-de-paginas-web'
  },
  themeColor: '#4e54c8',
  ...
  openGraph: {
    ...
    description:
      'Descubre diseños web únicos y funcionales en nuestro portafolio. Cada sitio está optimizado para SEO, ofreciendo una experiencia de usuario excepcional. Encuentra la inspiración para tu próxima página web aquí.',
    url: 'https://www.logosperu.com.pe/portafolio/diseno-de-paginas-web',
...
export default async function Portafolio () {
  const texto = 'diseno-de-paginas-web'
