      ...
      <main className="main">
        <section className="main__right">
          <div className="main__right__title">
            <h2>Cuestionario - Desarrollo Web LandingPage</h2>
          </div>
            ...
            <form className="">
              <ol>
                ...
                <li>
                  ...
                  <div className="radio-container radio-container2 radio-container3 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 w-full justify-center items-center gap-8 mt-8 & > div > text-center border py-5">
                    <div className="radio-wrapper">
                      <label className="radio-button">
                        ...
                        <span className="radio-label ml-3">
                          <Link
                            to="https://logosperu.com/plantillas/landing_page/1"
                            target="_blank"
                          >
                            Plantilla 1
                          </Link>
                    ...
                    <div className="radio-wrapper">
                      <label className="radio-button">
                        ...
                        <span className="radio-label ml-3">
                          <Link
                            to="https://logosperu.com/plantillas/landing_page/2"
                            target="_blank"
                          >
                            Plantilla 2
                          </Link>
                    ...
                    <div className="radio-wrapper">
                      <label className="radio-button">
                        ...
                        <span className="radio-label ml-3">
                          <Link
                            to="https://logosperu.com/plantillas/landing_page/3"
                            target="_blank"
                          >
                            Plantilla 3
                          </Link>
                    ...
                    <div className="radio-wrapper">
                      <label className="radio-button">
                        ...
                        <span className="radio-label ml-3">
                          <Link
                            to="https://logosperu.com/plantillas/landing_page/4"
                            target="_blank"
                          >
                            Plantilla 4
                          </Link>
