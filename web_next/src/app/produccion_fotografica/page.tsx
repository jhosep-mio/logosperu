...
export const metadata = {
  title: 'Producción Fotográfica - Logos Perú',
  description:
    'Capturamos momentos únicos a través de nuestro excepcional servicio de producción fotográfica, asegurando imágenes que cuentan una historia y resaltan la belleza y autenticidad de cada instante. Convierte tus momentos especiales en recuerdos inolvidables con nuestra dedicación y ojo artístico',
  msvalidate: 'A01D8EBEAA551809606CCFFE234E6DF5',
  alternate: {
    canonical: 'https://logosperu.com.pe/produccion_fotografica'
  },
  themeColor: '#4e54c8',
  ...
  openGraph: {
    title: 'Producción Fotografica - Logos Perú',
    description:
      'Capturamos momentos únicos a través de nuestro excepcional servicio de producción fotográfica, asegurando imágenes que cuentan una historia y resaltan la belleza y autenticidad de cada instante. Convierte tus momentos especiales en recuerdos inolvidables con nuestra dedicación y ojo artístico',
    url: 'https://www.logosperu.com.pe/produccion_fotografica',
    site_name: 'Logos Perú',
    type: 'website',
    images: [
      {
        url: 'https://logosperu.com/public/img/seo/SEO_PRODUCCION_FOTOGRAFICA.jpg'
      }
    ]
  },
  twitter: {
    ...
    creator: '@DLogosPeru',
    image:
      'https://logosperu.com/public/img/seo/SEO_PRODUCCION_FOTOGRAFICA.jpg'
  }
}

const getData = () => {
  return axios.get(`${Global.url}/getItemsToPortafolioWhereSubCategorias/13`, {
    headers: {
