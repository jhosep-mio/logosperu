...
export const metadata = {
  title: 'Portafolio de Brochure - Logos Perú',
  description:
    'Descubre un portafolio que resalta en el diseño de brochures, donde cada pieza es una obra maestra de creatividad y diseño estratégico.',
