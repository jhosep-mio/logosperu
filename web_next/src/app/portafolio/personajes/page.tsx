...
export const metadata = {
  title: 'Portafolio de Diseño de Personajes - Logos Perú',
  description:
    'Adéntrate en un mundo donde cada personaje es diseñado con pasión y detalle excepcional. Explora una galería diversa de personajes únicos, cada uno con su propia personalidad y estilo',
  msvalidate: 'A01D8EBEAA551809606CCFFE234E6DF5',
  alternate: {
    canonical: 'https://logosperu.com.pe/portafolio/personajes'
  },
  themeColor: '#4e54c8',
  ...
  openGraph: {
    ...
    description:
      'Adéntrate en un mundo donde cada personaje es diseñado con pasión y detalle excepcional. Explora una galería diversa de personajes únicos, cada uno con su propia personalidad y estilo',
    url: 'https://logosperu.com.pe/portafolio/personajes',
