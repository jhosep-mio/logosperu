...
export const AgregarCorreos = ({
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center gap-y-2 border border-b-gray-400 p-2 ">
      <div className="flex-1 flex flex-col  md:flex-row items-center gap-4">
        <input placeholder="Agregar correo" className='text-black outline-none px-2 py-2' type='email' value={correo} onChange={(e) => { setCorreo(e.target.value) }}
