...
export const metadata = {
  title: 'Portafolio Web Administrable - Logos Perú',
  description:
        'Descubre diseños web únicos y funcionales en nuestro portafolio. Cada sitio está optimizado para SEO, ofreciendo una experiencia de usuario excepcional. Encuentra la inspiración para tu próxima página web aquí.',
  msvalidate: 'A01D8EBEAA551809606CCFFE234E6DF5',
  alternate: {
    canonical: 'https://logosperu.com.pe/portafolio/diseno-de-paginas-web/web_administrable'
  },
  themeColor: '#4e54c8',
  ...
  openGraph: {
    ...
    description:
          'Descubre diseños web únicos y funcionales en nuestro portafolio. Cada sitio está optimizado para SEO, ofreciendo una experiencia de usuario excepcional. Encuentra la inspiración para tu próxima página web aquí.',
    url: 'https://www.logosperu.com.pe/portafolio/diseno-de-paginas-web/web_administrable',
