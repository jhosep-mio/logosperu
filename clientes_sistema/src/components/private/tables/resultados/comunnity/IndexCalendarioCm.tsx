...
import { type usurioValues, type ValuesPreventaModificate, type bannersValues } from '../../../../shared/Interfaces'
...
export const IndexCalendarioCm = ({ datos, getOneBrief }: { datos: bannersValues, getOneBrief: () => Promise<void> }): JSX.Element => {
  ...
  return (
    <>
      ...
      <section className="w-full h-[90%] px-6 pb-4 relative">
        ...
        <ModalDescripcion getOneBrief={getOneBrief} setEvents={setEvents} events={events} open={open} setOpen={setOpen} eventSelected={eventSelected} />
      </section>
    </>
  )
}
