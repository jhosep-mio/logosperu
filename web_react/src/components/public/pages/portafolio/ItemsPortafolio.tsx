...
import { getItemsToPortafolioWhereUrl } from '../../../shared/FechData'
...
export const ItemsPortafolio = (): JSX.Element => {
  ...
  useEffect(() => {
    ...
    setLoading(true)
    Promise.all([
      getItemsToPortafolioWhereUrl(
        `getSubcategoriaUrlToPortafolio/${texto ?? ''}`,
        'getSubCategoriasToPortafolioWhereUrl',
        'getItemsToPortafolioWhereSubCategorias',
        setProductos,
        setSubcategorias,
        setItems,
        setTotalRegistros
          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              <div className="boton_portafolio mt-0">
                <Link to={`/portafolio/${productos.url}`}>
