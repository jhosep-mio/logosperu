...
import carpeta from './../../../../assets/community/carpeta.jpg'
...
export const Listadocm = (): JSX.Element => {
            ...
            <section className="mt-4 grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-5 2xl:grid-cols-6 relative">
              ...
              {events?.map((producto: any) => (
                <Link
                  ...
                  className={
                    'w-full h-[100px] overflow-hidden md:h-[200px] bg-contain bg-center rounded-md p-4 before:bg-black/30 before:inset-0 before:absolute relative  hover:before:bg-black/10 transition-colors before:transition-colors cursor-pointer'
                  }
                >
