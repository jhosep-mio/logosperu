...
import { type ImagenState, type Values } from '../../../shared/schemas/Interfaces'
...
export const RegistrarBriefDiseño = (): JSX.Element => {
  ...
  const saveBrief = async (values: Values): Promise<void> => {
