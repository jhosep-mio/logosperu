...
import { type ValuesPreventaModificate, type ValuesPreventa, type validateClientes } from '../../../../shared/schemas/Interfaces'
...
export const RegistrarCliente = ({ datos }: { datos: ValuesPreventaModificate }): JSX.Element => {
  ...
  const savePreventa = async (values: ValuesPreventa): Promise<void> => {
    ...
    try {
      ...
      if (respuesta.data.status == 'success') {
        ...
        await axios.delete(`${Global.url}/destroyPreCliente/${datos.id ?? ''}`, {
          headers: {
            Authorization: `Bearer ${
                token !== null && token !== '' ? token : ''
              }`
