...
export const metadata = {
  title: 'Portafolio de Fotografía Corporativa - Logos Perú',
  description:
  ...
  alternate: {
    canonical: 'https://www.logosperu.com.pe/portafolio/audiovisual/fotografia_corporativa'
  },
  themeColor: '#4e54c8',
  ...
  openGraph: {
    ...
    description:
      'Descubre logotipos que no solo capturan la esencia de una marca, sino que también cuentan su historia de manera poderosa y efectiva.',
    url: 'https://www.logosperu.com.pe/portafolio/audiovisual/fotografia_corporativa',
...
export default async function Portafolio () {
  const texto = 'fotografia_corporativa'
