      ...
      if (respuesta2.data.status === "success") {
        ...
        try {
          let respuesta = await axios.post(
            `${Global.url}/saveBriefAdministrable`,
            data
          );
      ...
      <main className="main">
        <section className="main__right">
          <div className="main__right__title">
            <h2>Cuestionario - Desarrollo Web Administrable</h2>
          </div>
          ...
          <div className="main__right__form">
            <form action="" className="">
              <ol>
                ...
                <li>
                  <h5>
                    ¿Qué internas de las elegidas en la pregunta anterior desea
                    administrar? (Podrá modificar, eliminar y añadir el
                    contenido de las internas). <br />
                    La cantidad de internas administrables varía{" "}
                ...
                <li>
                  <h5>
                    ...
                    <strong>
                      {" "}
                      la cantidad de correos corporativos varía según el
                      contrato
                    </strong>
                  </h5>
                  <div className="input">
