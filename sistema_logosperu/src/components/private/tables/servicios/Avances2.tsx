...
//             //                     <p className="text-[#252525] lowercase first-letter:uppercase">ANELISSA COLLECTION</p>
...
//             //                 <h5 className="typografy_plan text-secundario text-3xl ">PLAN EXCEPCIONAL</h5>
//             //             </div>
//             //             <div className="flex py-4 px-4 text-[#252525]">
//             //                 <p className="font-semibold flex items-center flex-wrap gap-4">Colaborador a cargo: <span className="font-normal block p-1 px-4 bg-secundario/20 rounded-full">Milagros Chero</span></p>
//             //             </div>
//             //             <div className="flex py-4 px-4 pt-0 text-[#252525]">
//             //                 <p className="font-semibold flex items-center flex-wrap gap-2">Cliente: <span className="font-normal block p-1 px-4 rounded-full">Gabriel Stefano Garcia Rodriguez</span></p>
//             //             </div>
//             //         </div>
...
//             //             </div>
//             //             <div className="flex bg-white  flex-col gap-4 rounded-2xl p-4 border border-gray-300">
//             //                 <p className='text-center text-secundario font-semibold text-xl mb-4'>Porcentaje del proyecto</p>
