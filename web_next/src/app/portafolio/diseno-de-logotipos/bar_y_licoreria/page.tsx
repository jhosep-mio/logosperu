...
export const metadata = {
  title: 'Logotipos de Bar y Licoreria - Logos Perú',
  description:
  ...
  alternate: {
    canonical: 'https://www.logosperu.com.pe/portafolio/diseno-de-logotipos/bar_y_licoreria'
  },
  themeColor: '#4e54c8',
  ...
  openGraph: {
    ...
    description:
      'Descubre logotipos que no solo capturan la esencia de una marca, sino que también cuentan su historia de manera poderosa y efectiva.',
    url: 'https://www.logosperu.com.pe/portafolio/diseno-de-logotipos/bar_y_licoreria',
