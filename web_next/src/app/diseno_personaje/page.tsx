...
export const metadata = {
  title: 'Diseño de Personajes - Logos Perú',
  description:
            'Realizamos el diseño de tu mascota o personaje digital ya sea para tu negocio o publicidad, el servicio cuenta con diseñadores e ilustradores profesionales listos para crear el personaje perfecto para ti. Comienza este proyecto de diseño de personajes hoy y obtén un personaje que te encantará.',
  msvalidate: 'A01D8EBEAA551809606CCFFE234E6DF5',
  alternate: {
    canonical: 'https://logosperu.com.pe/diseno_personaje'
  },
  themeColor: '#4e54c8',
  ...
  openGraph: {
    ...
    description:
              'Realizamos el diseño de tu mascota o personaje digital ya sea para tu negocio o publicidad, el servicio cuenta con diseñadores e ilustradores profesionales listos para crear el personaje perfecto para ti. Comienza este proyecto de diseño de personajes hoy y obtén un personaje que te encantará.',
    url: 'https://logosperu.com.pe/diseno_personaje',
    site_name: 'Logos Perú',
    type: 'website',
    images: [
      {
        url: 'https://logosperu.com/public/img/seo/PORTADA_WE_PERSONAJE.png'
      }
    ]
  },
  twitter: {
    ...
    creator: '@DLogosPeru',
    image:
              'https://logosperu.com/public/img/seo/PORTADA_WE_PERSONAJE.png'
  }
}
// const getData = () => {
//   return axios.get(`${Global.url}/indexWhereCategoriaAleatorio/6`, {
//     headers: {
...
export default async function DisenoPersonajes () {
    ...
    <>
          ...
          <div className='row'>
            <div className='col-lg-12'>
              ...
              <div className='boton_portafolio'>
                <Link href='/portafolio/personajes'>
                  Ver Portafolio
                </Link>
              </div>
            </div>
              ...
              <div className='row'>
                <div className='col-lg-7'>
                  <div className='persona_titulo'>
                    <img
                      ...
                      src='/disenoPersonajes/tituloPersonaje.png'
                ...
                <div className='col-lg-5'>
                  <div className='conte_imagen_gif'>
                    <img src='/disenoPersonajes/fantasma.gif' alt='Gif Fantasma' />
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className='titulos'>
        <div className='container'>
          <div className='row'>
            <div className='col-lg-12'>
              <img className='mx-auto' src='/disenoPersonajes/tituloPersonaje2.png' alt='Titulo' />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className='row'>
            <div className='col-lg-5'>
              <div className='conte_imagen_gif2'>
                <img src='/disenoPersonajes/espanta.gif' alt='' className='max-w-[150%]' />
              </div>
            </div>
            <div className='col-lg-7'>
      ...
      <section className='titulos'>
        <div className='container'>
          <div className='row'>
            <div className='col-lg-12'>
              <img src='/disenoPersonajes/TITULO3.png' alt='Titulo' className='mx-auto' />
            </div>
          </div>
        </div>
      </section>
            ...
            <div className='col-lg-4'>
              <div className='body_proceso'>
                <div className='head_proceso'>
                  <img src='/disenoPersonajes/s1.png' className='img1 mx-auto' alt='' />
                </div>
                <div className='titulo_proceso'>
                  <h2>BRIEF</h2>
                </div>
                <div className='imagenp'>
                  <img src='/disenoPersonajes/paso1.png' alt='' className='mx-auto' />
                </div>
              </div>
            </div>
            <div className='col-lg-4'>
              <div className='body_proceso'>
                <div className='head_proceso'>
                  <img src='/disenoPersonajes/s2.png' className='img2 mx-auto' alt='' />
                </div>
                <div className='titulo_proceso'>
                  <h2>PROTOTIPADO</h2>
                </div>
                <div className='imagenp'>
                  <img src='/disenoPersonajes/paso2.png' alt='' className='mx-auto' />
                </div>
              </div>
            </div>
            <div className='col-lg-4'>
              <div className='body_proceso'>
                <div className='head_proceso'>
                  <img src='/disenoPersonajes/s3.png' className='img3 mx-auto' alt='' />
                </div>
                <div className='titulo_proceso'>
                  <h2>DIGITALIZAR</h2>
                </div>
                <div className='imagenp'>
                  <img src='/disenoPersonajes/paso3.png' alt='' className='mx-auto' />
                </div>
              </div>
            </div>
          </div>
