...
const SwiperPlanes = () => {
  const RedirigirWsp = (seleccion: number): void => {
    ...
    if (seleccion == 1) {
      mensaje =
        'Hola, estoy interesado(a) en obtener más información sobre el plan Flyer de S/. 89.'
    } else if (seleccion == 2) {
      mensaje =
        'Hola, estoy interesado(a) en obtener más información sobre el plan Flyer de S/. 149.'
    } else if (seleccion == 3) {
      mensaje =
        'Hola, estoy interesado(a) en obtener más información sobre el Plan Flyer de S/. 269.'
    }
