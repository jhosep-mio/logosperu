export const metadata = {
  title: 'Brochure - Logos Perú',
  description:
      'Proporcionamos servicios de alta calidad como diseño de logos, diseño web, diseño gráfico, audiovisual, alojamiento web que generan la construcción de una marca, a través de grandes impactos emocionales al consumidor, creando así experiencias vivenciales que permitan alcanzar la fidelidad y lealtad de los clientes.',
  msvalidate: 'A01D8EBEAA551809606CCFFE234E6DF5',
  alternate: {
    canonical: 'https://logosperu.com.pe/portafolio/brochure'
  },
  themeColor: '#4e54c8',
  ...
  openGraph: {
    ...
    description:
        'Proporcionamos servicios de alta calidad como diseño de logos, diseño web, diseño gráfico, audiovisual, alojamiento web que generan la construcción de una marca, a través de grandes impactos emocionales al consumidor, creando así experiencias vivenciales que permitan alcanzar la fidelidad y lealtad de los clientes.',
    url: 'https://logosperu.com.pe/portafolio/brochure',
    site_name: 'Logos Perú',
    type: 'website',
    images: [
      {
        url: 'https://logosperu.com/public/img/seo/BROCHURE.png'
      }
    ]
  },
  twitter: {
    ...
    creator: '@DLogosPeru',
    image:
        'https://logosperu.com/public/img/seo/BROCHURE.png'
  }
}
