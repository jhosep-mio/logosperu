...
export const metadata = {
  title: 'Portafolio de Etiquetas - Logos Perú',
  description:
    'Explora un portafolio de etiquetas donde cada diseño es una fusión de creatividad y estrategia de marca. Nuestros diseños personalizados capturan la esencia de cada producto, promoviendo su atractivo y diferenciación en el mercado con etiquetas que comunican calidad y autenticidad',
  msvalidate: 'A01D8EBEAA551809606CCFFE234E6DF5',
  alternate: {
    canonical: 'https://logosperu.com.pe/portafolio/etiquetas'
  },
  themeColor: '#4e54c8',
  ...
  openGraph: {
    ...
    description:
      'Explora un portafolio de etiquetas donde cada diseño es una fusión de creatividad y estrategia de marca. Nuestros diseños personalizados capturan la esencia de cada producto, promoviendo su atractivo y diferenciación en el mercado con etiquetas que comunican calidad y autenticidad',
    url: 'https://logosperu.com.pe/portafolio/etiquetas',
