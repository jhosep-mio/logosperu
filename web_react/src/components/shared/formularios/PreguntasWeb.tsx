...
export const PreguntasWeb = ({ seleccionPreguntas, setseleccionPreguntas }: { seleccionPreguntas: string, setseleccionPreguntas: Dispatch<SetStateAction<string>> }): JSX.Element => {
  return (
