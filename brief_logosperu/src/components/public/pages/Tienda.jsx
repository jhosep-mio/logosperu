  ...
  const saveBrief = async (datas) => {
    ...
    try {
      ...
      if (respuesta2.data.status === "success") {
        ...
        data.append("internas_administrables", datas.administrar);
      ...
      <main className="main">
        <section className="main__right">
          <div className="main__right__title">
            <h2>Cuestionario - Desarrollo Web Tienda</h2>
          </div>
          ...
          <div className="main__right__form">
            <form action="" className="">
              <ol>
                  ...
                  <div className="radio-container">
                    <div className="radio-wrapper">
                      <label className="radio-button">
                        ...
                        <span className="radio-label">
                          <Link
                            to="https://logosperu.com/plantillas/tienda/Plantilla_1/ "
                            target="_blank"
                          >
                            Plantilla 1
                          </Link>
                    ...
                    <div className="radio-wrapper">
                      <label className="radio-button">
                        ...
                        <span className="radio-label">
                          <Link
                            to="https://logosperu.com/plantillas/tienda/Plantilla_2/"
                            target="_blank"
                          >
                            Plantilla 2
                          </Link>
                    ...
                    <div className="radio-wrapper">
                      <label className="radio-button">
                        ...
                        <span className="radio-label">
                          <Link
                            to="https://logosperu.com/plantillas/tienda/Plantilla_3/"
                            target="_blank"
                          >
                            Plantilla 3
                          </Link>
                    ...
                    <div className="radio-wrapper">
                      <label className="radio-button">
                        ...
                        <span className="radio-label">
                          <Link
                            to="https://logosperu.com/plantillas/tienda/Plantilla_4/"
                            target="_blank"
                          >
                            Plantilla 4
                          </Link>
                    ...
                    <div className="radio-wrapper">
                      <label className="radio-button">
                        ...
                        <span className="radio-label">
                          <Link
                            to="https://logosperu.com/plantillas/tienda/Plantilla_5/"
                            target="_blank"
                          >
                            Plantilla 5
                          </Link>
                    ...
                    <div className="radio-wrapper">
                      <label className="radio-button">
                        ...
                        <span className="radio-label">
                          <Link
                            to="https://logosperu.com/plantillas/tienda/Plantilla_6/"
                            target="_blank"
                          >
                            Plantilla 6
                          </Link>
                    ...
                    <div className="radio-wrapper">
                      <label className="radio-button">
                        ...
                        <span className="radio-label">
                          <Link
                            to="https://logosperu.com/plantillas/tienda/plantilla_7/pages/inicio.php"
                            target="_blank"
                          >
                            Plantilla 7
                          </Link>
                    ...
                    <div className="radio-wrapper">
                      <label className="radio-button">
                        ...
                        <span className="radio-label">
                          <Link
                            to="https://logosperu.com/plantillas/tienda/plantilla_8/pages/inicio.php"
                            target="_blank"
                          >
                            Plantilla 8
                          </Link>
                    ...
                    <div className="radio-wrapper">
                      <label className="radio-button">
                        ...
                        <span className="radio-label">
                          <Link
                            to="https://logosperu.com/plantillas/tienda/plantilla_9/pages/inicio.php"
                            target="_blank"
                          >
                            Plantilla 9
                          </Link>
                ...
                <li>
                  <h5>
                    ¿Qué internas desea administrar? Noticias, Productos,
                    Servicios o Sliders (Podrá modificar, eliminar y añadir el
                    contenido de las internas). <br />
                    La cantidad de internas administrables es{" "}
                    <strong>según el contrato</strong>{" "}
                  </h5>
                  <div className="input">
                    <input
                      type="text"
                      placeholder="Home, Nosotros, Servicios, etc."
                      {...register("administrar", {
                        required: "Campo requerido",
                      })}
                    />
                  </div>
                  <Errors error={errors.administrar} />
                </li>
