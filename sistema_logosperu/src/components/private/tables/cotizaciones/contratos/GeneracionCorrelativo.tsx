    ...
    <>
      ...
      >
        <section className={`grid ${pdfUrl ? 'grid-cols-2' : 'grid-cols-1'}  gap-10`}>
            {values.id_contrato
              ? <ModalContratos getCotizaciones={getCotizaciones} selectedItem={selectedItem} datos={values} setPdfUrl={setPdfUrl} pdfUrl={pdfUrl} setLoading={setLoading} loading={loading}/>
