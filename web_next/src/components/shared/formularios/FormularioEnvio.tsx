...
import { valuesFormularioInternas } from '../interfaces/interfaces'
import { Global } from '../Helper/global'
import { SchemaFormularioEnvio } from '../interfaces/Schemas'
                ...
                <div className='bg-white p-20 rounded-lg'>
                  <form className='formulario'>
                    ...
                    <div className='row'>
                      ...
                      <div className='col-lg-12 flex justify-center items-center flex-col'>
                        <ReCAPTCHA
                          sitekey='6LeJacwnAAAAAOqiqM63wWKs_FjxV2tyyxWbFuaO'
                          onChange={handleCaptchaChange}
                          className='mx-auto scale-75 -ml-10 lg:scale-100 lg:ml-0'
                        />
